 ...
 *
 */
public class DSD_Manage extends ApplicationWindow{
	...
	public DSD_Manage ( ) throws Exception
	{
		super(null);
		ucvEditUC = (UBVDUCV) ABParmFactory.Factory.getItemByGUID("sd#UID510");
	}
...
//		xda.putData("#AppCode","spm");//设置运行的系统代码
		...
		DSD_Manage test = new DSD_Manage();
