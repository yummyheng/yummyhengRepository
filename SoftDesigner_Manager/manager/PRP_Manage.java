 ...
 *
 */
public class PRP_Manage extends ApplicationWindow
{
	UBVDGUItree treeDes;
	UBVDUCV ucvEditUC;
	...
	public PRP_Manage ( ) throws Exception
	{
		super(null);
		ucvEditUC = (UBVDUCV) ABParmFactory.Factory.getItemByGUID("sd#UID702");
	}
	public PRP_Manage (UBVDUCV ucvEditUCnew ) throws Exception
	{
	...
	{ 
		...
		PRP_Manage test = new PRP_Manage();
