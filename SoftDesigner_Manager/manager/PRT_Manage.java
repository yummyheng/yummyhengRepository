...
/**
 *	PRT 打印形参(模板)描述管理维护程序
 *  @author 任凯 2011-2-22
 *  @comments:
 *
 */
public class PRT_Manage extends ApplicationWindow
{
	UBVDGUItree treeDes;
	UBVDUCV ucvEditUC;
	...
	public PRT_Manage ( ) throws Exception
	{
		super(null);
		ucvEditUC = (UBVDUCV) ABParmFactory.Factory.getItemByGUID("sd#UID701");
	}
	public PRT_Manage (UBVDUCV ucvEditUCnew ) throws Exception
	{
	...
	{ 
		...
		PRT_Manage test = new PRT_Manage();
