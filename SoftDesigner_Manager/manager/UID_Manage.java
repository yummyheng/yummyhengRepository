 ...
 * @author 任凯  2011/2/17
 */
public class UID_Manage extends ApplicationWindow
{
	UBVDGUItree treeDes;
	UBVDUCV ucvEditUC;
	...
	public UID_Manage ( ) throws Exception
	{
		super(null);
		ucvEditUC = (UBVDUCV) ABParmFactory.Factory.getItemByGUID("sd#UID102B");//平铺样式主窗口
		
	}
	public UID_Manage (UBVDUCV ucvEditUCnew ) throws Exception
	{
...
//		xda.putData("#AppCode","bla");//设置运行的系统代码
		...
		UID_Manage test = new UID_Manage();
