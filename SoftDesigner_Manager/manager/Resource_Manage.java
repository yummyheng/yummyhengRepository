 ...
 *
 */
public class Resource_Manage extends ApplicationWindow
{
	UBVDGUItree treeDes;
	UBVDUCV ucvEditUC;
	...
	public Resource_Manage ( ) throws Exception
	{
		super(null);
		ucvEditUC = (UBVDUCV) ABParmFactory.Factory.getItemByGUID("sd#UID511");
	}
	public Resource_Manage (UBVDUCV ucvEditUCnew ) throws Exception
	{
	...
	{ 
		...
		Resource_Manage test = new Resource_Manage();
