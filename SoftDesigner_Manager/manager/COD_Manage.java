 ...
 *
 */
public class COD_Manage extends ApplicationWindow
{
	UBVDGUItree treeDes;
	UBVDUCV ucvEditUC;
	...
	public COD_Manage ( ) throws Exception
	{
		super(null);
		ucvEditUC = (UBVDUCV) ABParmFactory.Factory.getItemByGUID("sd#UID1157");
	}
	public COD_Manage (UBVDUCV ucvEditUCnew ) throws Exception
	{
	...
	{ 
		...
		COD_Manage test = new COD_Manage();
