 ...
 *
 */
public class SV_Manage extends ApplicationWindow
{
	UBVDGUItree treeDes;
	UBVDUCV ucvEditUC;
	...
	public SV_Manage ( ) throws Exception
	{
		super(null);
		ucvEditUC = (UBVDUCV) ABParmFactory.Factory.getItemByGUID("sd#UID1180SV");
	}
	public SV_Manage (UBVDUCV ucvEditUCnew ) throws Exception
	{
